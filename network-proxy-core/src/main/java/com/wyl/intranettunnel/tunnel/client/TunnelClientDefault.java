...
import com.wyl.intranettunnel.proxy.tcp.client.TcpProxyClientDefault;
import com.wyl.intranettunnel.proxy.udp.client.UdpProxyClientDefault;
...
public class TunnelClientDefault extends EventListener implements TunnelClient {
    ...
    public RequestStream sendAndRequest(String event, Entity entity, long timeout) throws IOException {
        return clientSession.sendAndRequest(event, entity, timeout);
    }
