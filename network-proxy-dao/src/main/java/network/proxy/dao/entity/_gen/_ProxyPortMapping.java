...
/**
 *  端口映射: proxy_port_mapping
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ProxyPortMapping extends DynamicOrmEntity{
    
    /* Id: ID INTEGER */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 客户端: CLIENT_ID INTEGER */
    ...
    public static final int PROP_ID_serverPort = 3;
    ...
    /* relation: 客户端 */
    public static final String PROP_NAME_client = "client";
    ...
    /* 客户端: CLIENT_ID */
    private java.lang.Integer _clientId;
    ...
    public _ProxyPortMapping(){
        // for debug
    }

    protected ProxyPortMapping newInstance(){
        ProxyPortMapping entity = new ProxyPortMapping();
    ...
    @Override
    public ProxyPortMapping cloneInstance() {
        ProxyPortMapping entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "network.proxy.dao.entity.ProxyPortMapping";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_clientId:{
               onInitProp(propId);
               this._clientId = (java.lang.Integer)value;
     ...
     * 客户端
     */
    public network.proxy.dao.entity.ProxyClients getClient(){
       return (network.proxy.dao.entity.ProxyClients)internalGetRefEntity(PROP_NAME_client);
    }

    public void setClient(network.proxy.dao.entity.ProxyClients refEntity){
           ...
           internalSetRefEntity(PROP_NAME_client, refEntity,()->{
           
                           this.setClientId(refEntity.getId());
